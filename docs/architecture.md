...
### 4.5 财报日历同步与 Reconciliation 契约（4.2A contract ratified；4.2B schema foundation 已实现；4.2C-1 至 4.2C-5 已实现；offline replay 尚未实现）
...
retry 从窗口起点重新抓取，不等于 offline replay。以下列表是 ratified contract；其中真正的
offline replay、company matching、candidate creation、reconciliation policy、monitoring
pool selector 与 live Provider 仍未实现（余下 4.2C /
4.2D-4.2F）：
